  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col h-full border-r border-white/5 glass relative z-30">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 custom-scrollbar">
        ...
        <div className="mb-8">
          <p className="px-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-4">创建的歌单</p>
          <div className="space-y-1">
            {MOCK_MY_PLAYLISTS.map((playlist) => (
              <NavItem 
                key={playlist.id} 
                icon={<PlaylistIcon />} 
...
const PlaylistIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v15l5-2 5 2V10"/><path d="M3 10h4"/></svg>;
